# Contributing to PHP Markdom Handler
...
Here’s an example workflow for `php-handler` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/php-handler`
- Clone your project  

```
git clone git@git.markenwerk.net:yourname/php-handler.git
```
